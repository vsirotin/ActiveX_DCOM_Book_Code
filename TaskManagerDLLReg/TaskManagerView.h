...
extern "C" __declspec(dllimport) LRESULT Pause(UINT nJob, CString strReason);
extern "C" __declspec(dllimport) LRESULT NewJob(CString strUserName);
extern "C" __declspec(dllimport) void JobOk(UINT nJob);
