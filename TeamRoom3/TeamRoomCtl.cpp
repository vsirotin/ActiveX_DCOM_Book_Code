...
BEGIN_EVENT_MAP(CTeamRoomCtrl, COleControl)
	...
	EVENT_CUSTOM("ClickInRoom", FireClickInRoom, VTS_BSTR)
...
/*
void CTeamRoomCtrl::OnRButtonDown(UINT nFlags, CPoint point) 
{
...
void CTeamRoomCtrl::OnLButtonUp(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
	...
	for(int i = 0; i < iSize; i++)
	{
		...
		if(pRoom->HitTest(rectClient, m_sizeInMetr, point))
		{
			FireClickInRoom(LPCSTR(pRoom->m_strName));
		}
	}
