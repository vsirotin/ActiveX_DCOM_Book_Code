========================================================================
		ActiveX Control DLL : TEAMROOM
========================================================================

ControlWizard has created this project for your TEAMROOM ActiveX Control
...
that make up your TEAMROOM ActiveX Control DLL.
...
TeamRoomCtl.h
	This file contains the declaration of the CTeamRoomCtrl C++ class.

TeamRoomCtl.cpp
	This file contains the implementation of the CTeamRoomCtrl C++ class.

TeamRoomPpg.h
	This file contains the declaration of the CTeamRoomPropPage C++ class.

TeamRoomPpg.cpp
	This file contains the implementation of the CTeamRoomPropPage C++ class.

TeamRoomCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CTeamRoomCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file TeamRoom.rc.
