...
EXTERN_C const IID IID_IIntCircuitCtl;
    ...
    public:
        ...
        virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE get_CountByIndex( 
            /* [in] */ short sIndex,
            /* [retval][out] */ short __RPC_FAR *pVal) = 0;
        
        virtual /* [helpstring][id][propput] */ HRESULT STDMETHODCALLTYPE put_CountByIndex( 
            /* [in] */ short sIndex,
            /* [in] */ short newVal) = 0;
    ...
    typedef struct IIntCircuitCtlVtbl
    {
        ...
        /* [helpstring][id][propget] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *get_CountByIndex )( 
            IIntCircuitCtl __RPC_FAR * This,
            /* [in] */ short sIndex,
            /* [retval][out] */ short __RPC_FAR *pVal);
        
        /* [helpstring][id][propput] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *put_CountByIndex )( 
            IIntCircuitCtl __RPC_FAR * This,
            /* [in] */ short sIndex,
            /* [in] */ short newVal);
...
#define IIntCircuitCtl_get_CountByIndex(This,sIndex,pVal)	\
    (This)->lpVtbl -> get_CountByIndex(This,sIndex,pVal)

#define IIntCircuitCtl_put_CountByIndex(This,sIndex,newVal)	\
    (This)->lpVtbl -> put_CountByIndex(This,sIndex,newVal)
...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE IIntCircuitCtl_get_CountByIndex_Proxy( 
    IIntCircuitCtl __RPC_FAR * This,
    /* [in] */ short sIndex,
    /* [retval][out] */ short __RPC_FAR *pVal);


void __RPC_STUB IIntCircuitCtl_get_CountByIndex_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id][propput] */ HRESULT STDMETHODCALLTYPE IIntCircuitCtl_put_CountByIndex_Proxy( 
    IIntCircuitCtl __RPC_FAR * This,
    /* [in] */ short sIndex,
    /* [in] */ short newVal);


void __RPC_STUB IIntCircuitCtl_put_CountByIndex_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
